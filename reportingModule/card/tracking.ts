...
export default [
  ...
  new CreateTableJQL({
    ...
    name: 'intermediate',
    $as: new Query({
      $select: [new ResultColumn(new ColumnExpression('sm', 'group'), 'group'), new ResultColumn(new FunctionExpression('SUM', new ColumnExpression('t', 'count')), 'count')],
      $from: new FromTable(
        'tracking',
        't',
  ...
  new Query({
    $select: [
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Not in Track'), new ColumnExpression('count')), 0),
        'notInTrack'
      ),
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Processing'), new ColumnExpression('count')), 0),
        'processing'
      ),
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Cargo Ready'), new ColumnExpression('count')), 0),
        'cargoReady'
      ),
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Departure'), new ColumnExpression('count')), 0),
        'departure'
      ),
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Arrival'), new ColumnExpression('count')), 0),
        'arrival'
      ),
      new ResultColumn(
        new FunctionExpression('IFNULL', new FunctionExpression('FIND', new BinaryExpression(new ColumnExpression('group'), '=', 'Delivered'), new ColumnExpression('count')), 0),
        'delivered'
      ),
    ],
    $from: 'intermediate',
