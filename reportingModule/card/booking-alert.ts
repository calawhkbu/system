import { ColumnExpression, CreateTableJQL, FromTable, BetweenExpression, FunctionExpression,BinaryExpression, GroupBy, Query, ResultColumn } from 'node-jql'
...
const query = new Query({
    $select: [
        new ResultColumn(new FunctionExpression('CONCAT',new ColumnExpression('alertType'),"Title"), 'alertTypeTitle'),
