    ...
    return new CreateTableJQL({
        ...
        $as: new Query({
            $select: [
                ...
                new ResultColumn(
                    new FunctionExpression('IFNULL', new FunctionExpression('SUM', new ColumnExpression('totalCount')),
                        0), 'totalCount'
                ),

                new ResultColumn(
                    new FunctionExpression('IFNULL', new FunctionExpression('SUM', new ColumnExpression('totalChargeableWeight')),

                        0), 'totalChargeableWeight'
                ),
...
export default [
    ...
    new Query({
        ...
        $select: [
            ...
            new ResultColumn(new FunctionExpression('IFNULL', new ColumnExpression('month', 'totalCount'), 0), 'totalCount'),
            new ResultColumn(new FunctionExpression('IFNULL', new ColumnExpression('month', 'totalChargeableWeight'), 0), 'totalChargeableWeight'),
