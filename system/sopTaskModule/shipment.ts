...
export const criteriaFields = [
  ...
  },
  {
    ...
    handle: handleAutoSelectAnyParty('shipment'),
    check: checkAutoSelectAnyParty('shipment')
  },
  {
    name: 'shipper',
    component: {
    ...
    handle: handleAutoSelectParty('shipment'),
    check: checkAutoSelectParty('shipment')
  },
  {
    name: 'consignee',
    component: {
