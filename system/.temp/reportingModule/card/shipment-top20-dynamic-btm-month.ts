  ...
  jqls: [
...

    {
      ...
      async prepareParams(params, prevResult: Result, user): Promise<IQueryParams> {
        ...
        if (dynamicColumnGroupByEntity == 'portOfLoading') {
          dynamicColumnCodeColumnName = dynamicColumnGroupByEntity + 'Code';
          dynamicColumnNameColumnName = dynamicColumnGroupByEntity + 'Name';
        }
