...
const app = {
  constants: {
    ...
    // url: 'https://api-prod.swivelsoftware.asia',
    authorizationToken:
  ...
  getUrl: (headers: any, body: any, constants: { [key: string]: any }) => `${constants.url}/reports/uber`,
  requestHandler: async(
    ...
    if (fields.includes('primaryKey')) {
      ['division', 'jobNo', 'houseNo'].map(x => {// for getting primary key
