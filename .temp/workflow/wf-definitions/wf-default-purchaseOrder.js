...
module.exports = {
  ...
  transitions: {
    'New Order': {
      allowableNextStates: ['Confirm Order'],
      requiredActions: ['Confirm Order'],
    },
    'Confirm Order': {
      allowableNextStates: ['Assign Logistics Provider', 'Cancelled'],
      requiredActions: ['Assign Logistics Provider'],
    },
    'Assign Logistics Provider': {
      allowableNextStates: ['Assign Schedules'],
      requiredActions: ['Assign Schedules'],
    },
    'Assign Schedules': {
      allowableNextStates: ['Book Shipment', 'Cancelled'],
      requiredActions: ['Assign Logistics Provider'],
    },
    'Book Shipment': {
      allowableNextStates: ['Approve Shipment'],
      requiredActions: ['Book Shipment for PO'],
    },
    'Approve Shipment': {
      allowableNextStates: ['Shipment Ready', 'Cancelled'],
      requiredActions: ['Approve Shipment'],
    },
    'Shipment Ready': {
      allowableNextStates: ['Shipment Departed'],
      requiredActions: ['Mark Departure'],
    },
    'Shipment Departed': {
      allowableNextStates: ['Completed'],
      requiredActions: ['Confirm Shipment'],
    },
    Completed: {
      allowableNextStates: [],
    },
