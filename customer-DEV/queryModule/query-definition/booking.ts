...
export default function (query: QueryDef) {
  const cooQuery = new MathExpression(
  ...
  const dateStatusExpression = (queryParam: IQueryParams) => {
    ...
    const rawfinalDoorDeliveryActualExpression = new ColumnExpression('booking_date', 'finalDoorDeliveryDateActual')
    const rawfinalDoorDeliveryEstimatedExpression = new ColumnExpression('booking_date', 'finalDoorDeliveryDateEstimated')

    const rawsentToCosigneeActualExpression = new ColumnExpression('booking_date', 'sentToConsigneeDateActual')
    const rawsentToCosigneeEstimatedExpression = new ColumnExpression('booking_date', 'sentToConsigneeDateEstimated')
  ...
  registerAll(query, 'booking', fieldList, true)
  return query
}
