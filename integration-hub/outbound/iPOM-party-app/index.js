      ...
      .then(customer => {
        if (customer && customer.configuration && customer.configuration.webService.purchaseOrder && customer.configuration.webService.purchaseOrder.partyApi) {
          ...
          try {
            helper.restClient.post(api, payload, (data, res) => {
              ...
              if (data) {
                if (res.statusCode === 200) {
                  ...
                  helper.saveLog(appId, api, 'party', party.id, payload, data, null);
                }
                else {
                  ...
                  helper.saveLog(appId, api, 'party', party.id, payload, null, data);
                }
              }
            })
          }
            ...
            helper.saveLog(appId, api, 'party', party.id, payload, null, JSON.stringify(e));
          }
        }
      })
  }
